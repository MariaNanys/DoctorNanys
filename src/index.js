...
import fotelImg from './images/fotel.webp';
...
const introImageElement = document.querySelector('.main__intro-image');
if (introImageElement) {
    introImageElement.style.backgroundImage = `url(${fotelImg})`;
    introImageElement.style.opacity = 0.3;
}
